...
var router = function(config) {
  ...
  // routes
  appRouter.get('/', dispatcher);
  appRouter.post('/checkValid', dispatcher);
  appRouter.get('/:databaseType/:connectionName/:methodName', dispatcher); 
  appRouter.get('/:databaseType/:connectionName/:databaseName/:methodName', dispatcher);
  appRouter.get('/:databaseType/:connectionName/:databaseName/:collectionName/:methodName', dispatcher);
